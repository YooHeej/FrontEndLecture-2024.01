...
// 1. 현재 날짜 / 시간
let today = new Date();
console.log(today);                                 // 2024-01-08T04:49:04.702Z
console.log(today.toISOString());                   // 2024-01-08T04:49:04.702Z
console.log(today.toLocaleString());                // 2024. 1. 8. 오후 1:49:04
...
let lastChristmas = new Date(2023, 11, 25, 19, 30);
console.log(myDateTime(lastChristmas));

// 3. Unix time (1970-01-01 00:00:00 이 후 ms 단위)
...
// 더하기, 빼기
let date = new Date()
date.setDate(date.getDate() + 100);             // 100일 후
console.log(myDateTime(date));
date.setDate(date.getDate() - 100);             // 100일 이 후에서 100일 전 = 오늘
console.log(myDateTime(date));

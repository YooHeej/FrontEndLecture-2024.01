...
console.log(new Date().toLocaleString());                     // 2024. 1. 8. 오전 11:18:29
...
console.log(myDateTime());                  // 2024-01-08 11:27:27
...
console.log(sample.replace('o','O')); // 앞에 있는 것 한 개만 바뀐다.

// 정규 표현식 (딥 러닝을 이용한 자연어 처리 입문 > 02-05 정규 표현식 참조 https://wikidocs.net/21703)
...
if (hello.indexOf('안녕') >= 0)
    console.log(`찾고 싶은 단어 ${search} 이/가 문장 안에 있습니다.`);
else
    console.log(`찾고 싶은 단어 ${search} 이/가 문장 안에 없습니다.`);
